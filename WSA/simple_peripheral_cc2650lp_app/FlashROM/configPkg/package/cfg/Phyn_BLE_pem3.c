...
#ifndef __TI_COMPILER_VERSION__
__T1_ti_sysbios_knl_Task_Instance_State__stack ti_sysbios_knl_Task_Instance_State_0_stack__A[256] __attribute__ ((section(".bss:taskStackSection")));
#endif
#endif
#ifdef __ti__align
...
#ifdef __GNUC__
#ifndef __TI_COMPILER_VERSION__
__T1_ti_sysbios_knl_Task_Instance_State__stack ti_sysbios_knl_Task_Instance_State_0_stack__A[256] __attribute__ ((aligned(8)));
#endif
#endif
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/BLE/WSA/simple_peripheral_cc2650lp_app/FlashROM/configPkg/package/cfg/Phyn_BLE_pem3");
